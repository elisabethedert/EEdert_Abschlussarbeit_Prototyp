...
<template>
    <div class="figure">
        <svg width="250" height="250" viewBox="0 0 500 500" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle class="sad head" cx="318" cy="208" r="75" fill="#E3A328" />
            <circle cx="202" cy="265" r="111" fill="#E3A328" />
            <circle class="sad eyes" cx="374" cy="183" r="32.5" stroke="black" stroke-width="5" fill="#FCF9E7" />
            <circle class="sad eyes" cx="262" cy="183" r="32.5" stroke="black" stroke-width="5" fill="#FCF9E7" />
